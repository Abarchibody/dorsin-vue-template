      ...
      <div class="row">
        <div class="col-lg-6">
          <ul class="list-inline social margin-t-20">
            ...
            ></li>
            <li class="list-inline-item"
              ><a href="" class="social-icon"><i class="mdi mdi-dribbble"></i></a
            ></li>
          </ul>
        </div>
        <div class="col-lg-3 margin-t-30">
          <p class="margin-b-0 contact-title">
            <i class="pe-7s-call"></i> &nbsp;<a href="tel:+243 81 20 44 091">+243 81 20 44 091</a>
          </p>
        </div>
        <div class="col-lg-3 margin-t-30 text-right">
          <p class="contact-title">
            <i class="pe-7s-mail-open"></i>&nbsp; <a href="mailto:me@abarchibody.com">me@abarchibody.com</a>
          </p>
        </div>
      </div>
    </div>
